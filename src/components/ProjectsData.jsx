...
const Projectdata = [
    ...
    {
        id:2,
        image: 'https://i.ibb.co/NK9p93K/restaurant.jpg',
    ...
    {
        id:3,
        image: 'https://i.ibb.co/WtKVzyn/construction.png',
    ...
    {
        id:4,
        image: 'https://i.ibb.co/v3LG0yF/box.png',
    ...
    {
        id:5,
        image: 'https://i.ibb.co/bzbRSk5/button.png',
    ...
    {
        id:6,
        image: 'https://i.ibb.co/JkyWNLm/expending.jpg',
    ...
    {
        id:7,
        image : 'https://i.ibb.co/cQCnBX8/gkeep.png',
    ...
    {
        id:8,
        image : 'https://i.ibb.co/HBmqkbZ/imagsearch.png',
    ...
    {
        id:9,
        image : 'https://i.ibb.co/2gYRHBT/todoapp.png',
    ...
    {
        id:10,
        image : 'https://i.ibb.co/SdYDw8j/faq.png',
        projectTitle:'FAQ',
        projectTools:'HTML,CSS,Javascript',
    ...
    {
        id:11,
        image : 'https://i.ibb.co/3YCfRFZ/imggallery.png',
    ...
    {
        id:12,
        image : 'https://i.ibb.co/347Lxbn/github.png',
